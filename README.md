# Android大牛架构师成长计划
Android 牛X架构师的成长之路      最近更新:2019/12/04 15:30
...
## [开放的网络接口]
### [查看夜神模拟器端口]（https://blog.csdn.net/lovedingd/article/details/108409634）
### [七牛云视频压缩SDK](https://blog.csdn.net/qq_31796651/article/details/79154072)
### [视频相关](https://www.jianshu.com/p/78b7176c041e)
...
### [SwipeRecyclerView（支持长按、拖拽、侧滑删除等操作）](https://github.com/yanzhenjie/SwipeRecyclerView)
...
### [BaseRecyclerViewAdapterHelper（可以节省很多写adapter的代码）](https://github.com/wzlsz/BaseRecyclerViewAdapterHelper)
...
## [组件化]
### [一个还不错的组件化学习项目](https://github.com/1170762202/WanAndroid)
...
### [sqlbrite(良心企业Square的又一开源项目，当你不想给用ContentProvider，只想简单监听SQLite表增删改的数据变更时可以试试它。DBExecutor android ORM数据库 1.使用了读写锁，支持多线程操作数据。 2.支持操作多个数据库 3.支持事务 4.缓存Sql，缓存表结构。)](https://github.com/square/sqlbrite)
### [Hawk(一个快速和易用的键值对数据存储框架，支持AES加密，支持SharedPreferences或Sqlite存储，支持Gson解析。)](https://github.com/orhanobut/hawk)
